...
注釈の仕組みについて詳しくは、[Experience Leagueのビデオチュートリアルを参照してください](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/analysis-workspace/navigating-workspace-projects/annotations-in-analysis-workspace)。
...
詳細なドキュメントについては、[注釈の概要](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/components/annotations/overview)と関連する記事を参照してください。
