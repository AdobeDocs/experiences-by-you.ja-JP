---
title: の 10 のベストプラクティス [!DNL Adobe] [!DNL Campaign] マーケター向けの成功
description: 役立つ 10 のベストプラクティスを学ぶ [!DNL Adobe] [!DNL Campaign] 実務担当者は、デジタル消費者の変革を解き放ち、加速させ、顧客により優れたエクスペリエンスを提供します。
doc-type: article
solution: Campaign
...
# [!DNL の 10 のベストプラクティス [!DNL Adobe] [!DNL Campaign]] マーケター向けの成功

Christian Klimczyk は自称です」[!DNL Adobe] 7 年の [!DNL のオタク」 [!DNL Adobe] Experience Cloud] の専門知識（主に [!DNL [!DNL Adobe] [!DNL Campaign]]。 As a [!DNL Adobe] 大規模な CPG 企業のプラットフォームオーナー、Christian とそのチームは [!DNL [!DNL Campaign]]：あらゆるコンシューマーとの通信とインタラクションに使用します。 厳しい規制要件と、ダイレクトメール、メール、SMS／MMS にわたるマルチチャネルの消費者マーケティングキャンペーンをシームレスに調整および管理します。

この記事では、Christian が支援するベストプラクティスを紹介します [!DNL Adobe] [!DNL Campaign] 実務担当者は、デジタル消費者の変革を解き放ち、加速させ、顧客により優れたエクスペリエンスを提供します。


## 1. 包括的でまとまりのあるマーケティングと配信計画の作成

[!DNL で確実に成功するための最初の手順 [!DNL Adobe] [!DNL Campaign]] は、ツールと顧客の期待を理解することです。これは、あらゆるタイプのマーケティングに当てはまります。 消費者に連絡するために使用するチャネルを明確に定義して理解し、それらのチャネルを使用するタイミングと理由を把握します。
...
対象： [!DNL Adobe] [!DNL Campaign]を使用すると、セグメント化をすばやく簡単に調整できます。 ただし、このプロセスを合理化して促進するために、キャンペーンオペレーターとマーケティング担当者は、キャンペーンの作成と実行を設計およびリクエストする際に、基礎となるデータを文書化して理解する必要があります。 [!DNL をサポートする管理者や開発者と提携する際には、現在のデータと、必要になる可能性のあるデータを予測する方法を理解することが重要です [!DNL Campaign]] インスタンス。
...
例えば、顧客が朝に電話をチェックして最安値をチェックしている場合は、プロモーションのテキストメッセージを送信することを検討します。次のホットトレンドを夜にブラウジングしている場合は、無料配送のプロモコードを記載したフォローアップメールを送信することを検討します。[!DNL のヒートマップツールを使用することも重要です [!DNL Campaign]]：ワークフローと送信が実行されているタイミングを追跡します。 複数のブランド間で通信を調整して促進することは、困難な場合があります。[メールのリズム、ケイデンス、タイミングを監視し、把握する](https://experienceleaguecommunities.adobe.com/t5/adobe-campaign-classic-blogs/predictive-send-time-optimization-with-adobe-campaign/ba-p/561554?profile.language=ja) は、メッセージの全体的な安定性と強度にとって非常に重要です。 [!DNL Campaign] インスタンス。
...
[!DNL を専門的に使用することで、オプトインを管理し、この絶え間なく進化するエコシステムを育成するための戦略を前もって準備します [!DNL Adobe] [!DNL Campaign]] およびその他のマーケティングテクノロジーツール 多くの場合、これはキャンペーンの最大の成功指標の 1 つであるので、キャンペーン戦略が成長し、成熟するにつれて、慎重に計画することで計り知れない成果が得られます。
...
[デジタルマーケティングリーダーの 35％は、最大の課題は組織内にあると考えています](https://www.gartner.com/en/newsroom/press-releases/gartner-says-35--of-digital-marketing-leaders-believe-the-bigges)。これを実現するには、いくつかのプラットフォームでクロストレーニングを行い、データフローと構造などの理解を深めます [!DNL Adobe] ソリューションを提供し、キャンペーンの不測の事態に備えたプランを作成します。 この考え方は様々な方法で実現できますが、短期的および長期的な成功を収めるには、アジャイルと計画に対する全体的なコミットメントが重要です。
