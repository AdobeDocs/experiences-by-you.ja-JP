...
| 14 | **HTML版のハイパーリンクと UTM** | すべてのハイパーリンクが機能し、これらの領域に UTM が含まれていますか？ ：<ul><li>ヘッダーセクション</li><li>画像領域（含まれる場合）</li><li>本文</li><li>CTA</li>フッター</li></ul> | **はい：**<br> 壊れたリンクを送信しません。 「はい」と答えられない場合は、修正してから続行してください。 |  |
