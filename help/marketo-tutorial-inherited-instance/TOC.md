---
user-guide-title: チュートリアル – 継承したインスタンスを監査するためのヒントとテクニック
user-guide-description: 継承した [!DNL Marketo Engage]  インスタンスを監査するためのヒントとテクニック
breadcrumb-title: チュートリアル – 継承した [!DNL Marketo Engage]  インスタンスを監査するためのヒントとテクニック
...
# チュートリアル – 継承した[!DNL Marketo Engage] インスタンスを監査するためのヒントとテクニック {#auditing-an-inherited-instance}
...
+ [トラブルシューティング用のCRM同期エラーのログ](/help/marketo-tutorial-inherited-instance/log-crm-sync-errors-for-easy-troubleshooting.md)
