...
+ [!DNL Analytics] by You {#analytics}
   ...
   + [!DNL Analytics] {#intro-to-analytics} の概要
   ...
   + 管理 {#administration}
      + 主な管理スキル {#key-admin-skills}
         ...
         + [技術的  [!DNL Adobe Analytics]  用語を使用しない方法での専門用語の翻訳](../analytics/administration/key-admin-skills/translating-adobe-analytics-technical-language.md)
      ...
      + 管理に関するヒントとベストプラクティス {#admin-tips}
         ...
         + [内部サイト  [!DNL Adobe Analytics]  作成](../analytics/administration/admin-tips/create-an-internal-adobe-analytics-site.md)
...
+ [!DNL Campaign] by You {#campaign}
   ...
   + 戦略とソートリーダーシップ{#strategy}
      + [マーケター向けの成功  [!DNL Adobe Campaign]  ベストプラクティス 10 件](/help/campaign/10-best-practices-for-marketers.md)
+ あなたによるExperience Manager{#experience-manager}
   ...
   + AEM as a Cloud Service {#cloud-service}
      ...
      + ベストプラクティス {#cloud-manager-best-practices}
         + [Cloud Managerでのログの使用](/help/experience-manager/cloud-service/expert-resources/aem-champions/cloud-manager-using-logs.md)
         + [AEM as a Cloud Serviceへの移行の計画](/help/experience-manager/cloud-service/expert-resources/aem-champions/migration.md)
         + [Postの移行戦略とヒント](/help/experience-manager/cloud-service/expert-resources/aem-champions/post-migration.md)
